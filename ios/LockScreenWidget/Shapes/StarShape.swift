...
//
// Ref: https://www.hackingwithswift.com/quick-start/swiftui/how-to-draw-polygons-and-stars
...
struct Star: Shape {
    ...
    func path(in rect: CGRect) -> Path {
        ...
        path.addLine(to: CGPoint(x: center.x * cos(currentAngle), y: center.y * sin(currentAngle)))
